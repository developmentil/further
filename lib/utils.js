...
module.exports = {
	...
	log: function(level) {
		...
		if((typeof level !== 'string' || arguments.length === 1) && this.logger !== console)
			args.unshift('info');

		this.logger.log.apply(this, logParams.apply(this, args));
	},
	
	info: function() {
		this.logger.info.apply(this, logParams.apply(this, arguments));
	},
	
	warn: function() {
		this.logger.warn.apply(this, logParams.apply(this, arguments));
	},
	
	error: function() {
		this.logger.error.apply(this, logParams.apply(this, arguments));
	},
	
	werr: function(werr) {
		if(werr) this.logger.warn.apply(this, arguments);
	},
